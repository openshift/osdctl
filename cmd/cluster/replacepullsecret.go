...
func (o *replacePullSecretOptions) run(ctx context.Context) error {
	...
	if isHCP {
		...
		if !o.dryrun && op.AllOK {
			err = controller.UpdateHCPPullSecretViaManifestWork(ctx, ocm, masterKubeCli, o.clusterID, mgmtName, pullSecret, o.In, out)
			if err != nil {
		...
		if !o.dryrun && op.AllOK && resolvedHiveNS != "" {
			...
			err = controller.UpdateHivePullSecretSSS(ctx, masterKubeCli, masterKubeClientSet, resolvedHiveNS, resolvedCDName, pullSecret, o.In, out)
			if err != nil {
