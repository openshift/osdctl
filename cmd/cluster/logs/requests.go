...
func getAccessToken() (string, error) {
	clientSecret, err := getSecretFromVault()
	if err != nil {
		return "", err
	}
	...
	if !ok {
		return "", fmt.Errorf("Failed to acquire access token")
	}
...
func getRequestToken(query string, dtUrl string, token string) (string, error) {
