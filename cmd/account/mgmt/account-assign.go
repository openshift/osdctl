...
func (o *accountAssignOptions) run() error {
	...
	accountAssignID, err = o.findUntaggedAccount(seed, rootID)
	if err != nil {
		return err
	}
...
func (o *accountAssignOptions) findUntaggedAccount(seedVal int64, rootOu string) (string, error) {
	...
	if len(accounts.Accounts) == 0 {
		...
		accountAssignID, err := o.buildAccount(seedVal)
		if err != nil {
			return "", err
		}
